...
from config import (
    ...
    EPOCHS, LR_CNN, WEIGHT_DECAY, ADAM_BETAS,
    USE_LR_SCHEDULER, LR_WARMUP_EPOCHS,
    CHECKPOINTS_DIR, RESULTS_DIR,
    LENET_CONFIG, DEVICE, LOG_INTERVAL,
...
def main(args):
    ...
    # 5. 加载最佳模型并在测试集上评估
    logger.info("\n5. 测试集评估...")
    best_checkpoint = get_checkpoint_path("lenet")
    ...
    save_training_results(
        ...
        save_path=get_result_path("lenet")
    )
    
    logger.info("\n" + "="*60)
    logger.info("LeNet-5训练完成！")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="训练LeNet-5分类器")
    parser.add_argument("--batch_size", type=int, default=BATCH_SIZE,
                       help="批次大小")
    parser.add_argument("--epochs", type=int, default=EPOCHS,
                       help="训练轮数")
    parser.add_argument("--lr", type=float, default=LR_CNN,
                       help="学习率")
