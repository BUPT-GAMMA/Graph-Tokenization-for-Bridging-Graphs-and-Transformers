...
class MutagenicityLoader(BaseDataLoader):
    """Mutagenicity graph classification dataset (TU)."""

    def __init__(self, config: ProjectConfig, dataset_name: str = "mutagenicity", target_property: Optional[str] = None):
        ...
        self._normalized_name = "mutagenicity"
        self.load_data()

    def _load_processed_data(self) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]], List[Dict[str, Any]]]:
        logger.info(f"Loading Mutagenicity preprocessed data from: {self.data_dir}")
