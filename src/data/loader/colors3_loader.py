...
class COLORS3Loader(BaseDataLoader):
    ...
    def _extract_labels(self, data: List[Dict[str, Any]]) -> List[Any]:
        ...
        for sample in data:
            ...
            labels.append(int(props.get("label", 0)))
        return labels
    ...
    def load_data(self) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]], List[Dict[str, Any]], List[Any], List[Any], List[Any]]:
        res = super().load_data()
